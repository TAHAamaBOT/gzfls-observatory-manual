...
| 支架类型 | 电脑化地平式单叉臂经纬仪 |
| 有效载荷 | 10 lbs (4.54 kg) |
| 高度调节范围（含支架和三脚架） | 939.8 mm - 2397 mm (37" – 55") |
...
| 周期误差校正 | 无 |
| 手控器 | 双行18字符液晶显示屏，配备19个光纤背光LED按键 |
...
| 辅助端口数量 | 3个AUX接口 (1个用于手控器，2个AUX接口用于可选配件) |
| 自动导星接口 | 有 |
| USB端口 | 有，位于手控器上 |
...
| 周期误差校正 | 支持 |
| 手控器 | NexStar+手控器，带LCD显示屏，19个光纤背光LED按键 |
...
振旺**旗舰级**黑白深空相机，合成彩色照片需要搭配[2英寸UBVRI滤镜](#%EF%B8%8F-配件)拍摄。天文馆存有 1 台，连接在天文台主镜[**RC14**](#gso-rc14)上。
...
振旺深空摄影入门级相机，合成彩色照片需要搭配[1.25英寸ZWO LRGB滤镜](#%EF%B8%8F-配件)拍摄。天文馆存有 1 台。
...
振旺**旗舰款**导星相机，天文馆存有 1 台，连接在天文台主镜[**RC14**](#gso-rc14)上。
